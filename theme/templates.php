            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation  ml-auto d-none d-lg-block " role="navigation"  style="color: red" >
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="<?php echo WEB_ROOT; ?>">Głowna</a></li>
                  <li><a href="<?php echo WEB_ROOT; ?>index.php?page=3">Lista Przedmiotów</a></li>
                  <li><a href="<?php echo WEB_ROOT; ?>index.php?page=2">Informacje o Studencie</a></li>
                  <li><a href="<?php echo WEB_ROOT; ?>logout.php">Wyloguj</a></li>  
                </ul>
              </nav>
            </div>
