		  ...
		  <form class="form-horizontal span6" action="controller.php?action=enroll" method="POST">
					...
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Zapis Studentów</h3>
					  </div>
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <input class="form-control input-sm" id="idno" name="idno" readonly placeholder=
									  "ID Numer" type="text" value="<?php echo (isset($cur)) ? $cur->IDNO : 'ID' ;?>">
								</div>	  
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <input class="form-control input-sm" readonly placeholder=
									  "ID Numer" type="text" value="<?php echo (isset($cur)) ? $cur->LNAME.', '.$cur->FNAME : 'Fullname' ;?>">
								</div>	  
