		  ...
		  <form class="form-horizontal span6" action="controller.php?action=enroll" method="POST">
					...
					<div class="panel panel-primary col-offset-5">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span>Zapis Ucznia</h3>
					  </div>
				            ...
				            <div class="col-md-8">
				              ...
				              "Status">Status : </label> 
				                 <select class="form-control input-sm" name="Status" id="Status">
									<option value="New">Nowy Student</option>
									<option value="Continuing">Kontynuacja</option>	
									<option value="Trasferee">Transfer</option>	
								</select>
				              </div>
				            </div>
				          </div>
				    ...
				    <!--       <div class="form-group">
                      ...
                      "Pierwszy" type="hidden" value="First">

				          <div class="row" id="idno">
				            <div class="col-md-10">  
      						<div class="form-group">
							         <div class="btn-group"> 
							          <a href="index.php" name="back" class="btn btn-default">Cofnij </a>
									    <button type="submit" name="savestep1" class="btn btn-default"><span class="glyphicon glyphicon-floppy-save"></span> Zapisz</button>
