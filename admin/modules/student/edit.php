<?php 
			...
			?>
		        <form class="form-horizontal well span9" action="controller.php?action=edit&id=<?php echo $cur->IDNO; ?>" method="POST">
					...
					<fieldset>
						<legend>Nowy Student</legend>
															
 
			            <div class="col-md-4">
     					 <div class="form-group">
			              <label >ID Numer</label>  
			                 <input class="form-control input-sm" id="idno" name="idno" placeholder=
												  "ID Numer" type="text" value="<?php echo $cur->IDNO; ?>" readonly>
			              </div> 
			            </div>  
			            ...
			            <div class="row">
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "lName">Nazwisko:*</label> 
			                  <input class="form-control input-sm" id="lName" name="lName" type=
			                  "text" placeholder="NAzwisko" value="<?php echo $cur->LNAME; ?>">
			                </div>
			              </div>
			              ...
			              <div class="col-md-4">
			                ...
			                "fName">Imie:*</label> 
			                  ...
			                  "text" placeholder="Imie" value="<?php echo $cur->FNAME; ?>">
			                </div>
			              </div>
			              ...
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "mName">Drugie Imie:*</label> 
			                  <input class="form-control input-sm" id="mName" name="mName" type=
			                  "text" placeholder="Drugie imie" value="<?php echo $cur->MNAME; ?>">
			                </div>
			              </div>
			            </div> 
			            ...
			            <div class="row">
			              <div class="col-md-4">
			                ...
			                "gender">plec </label> 
				                <select class="form-control input-sm" name="gender" id="gender">
									...
									<option value="M">Mezczyna</option>
			              ...
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "bplace">Miejsce Narodzin</label> 
			                  <input class="form-control input-sm" id="bplace" name="bplace" type=
			                  "text" placeholder="Miejsce Narodzin" value="<?php echo $cur->BPLACE; ?>">
			                </div>
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="row">
			              ...
			              <div class="col-md-4">
			                ...
			                <label for=
			                "age">Wiek</label> 
			                  <input class="form-control input-sm" id="age" name="age" type="number" placeholder="wiek" value="<?php echo $cur->AGE; ?>">
			                </div>
			              </div>
			              ...
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "nationality">Narodowosc</label> 
			                  <input class="form-control input-sm" id="nationality" name="nationality" type=
			                  "text" placeholder="Narodowosc" value="<?php echo $cur->NATIONALITY; ?>">
			                </div>
			              </div>
			            </div> 
			            ...
			            <div class="row">
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "religion">Religia </label> 
				                 <input class="form-control input-sm" id="religia" name="religion" type=
			              ...
			              <div class="col-md-4">
      						<div class="form-group">
			                <label for=
			                "contact">Kontakt </label> 
			                  <input class="form-control input-sm" id="contact" name="contact" type="text" placeholder="Kontakt Numer" value="<?php echo $cur->CONTACT_NO; ?>">
			                </div>
			              </div>
			               <div class="col-md-4">
      						<div class="form-group">
		            ...
		            <div class="row">
		              <div class="col-md-6">
		                ...
		                "father">Ojciec </label> 
		                  ...
		                  "text" placeholder="Ojciec" value="<?php echo $det->FATHER; ?>">
		                </div>
		              </div>
		              ...
		              <div class="col-md-6">
		                ...
		                <label for=
		                "fOccu">zawód </label> 
		                  <input class="form-control input-sm" id="fOccu" name="fOccu" type="text" placeholder="zawód" value="<?php echo $det->FATHER_OCCU; ?>">
		                </div>
		              </div>
		            ...
		            <div class="row">
		              <div class="col-md-6">
		                ...
		                "mother">Matka </label> 
		                  ...
		                  "text" placeholder="Matka" value="<?php echo $det->MOTHER; ?>">
		                </div>
		              </div>
		              ...
		              <div class="col-md-6">
		                ...
		                <label for=
		                "mOccu">zawód </label> 
		                  <input class="form-control input-sm" id="mOccu" name="mOccu" type="text" placeholder="zawód" value="<?php echo $det->MOTHER_OCCU; ?>">
		                </div>
		              </div>
				...
				<div class="form-group">
		            <div class="row">
		              <div class="col-md-6">
      					<div class="form-group">
		                <label for=
		                "guardian">Opiekun </label> 
			                 <input class="form-control input-sm" id="guardian" name="guardian" type=
		                  "text" placeholder="Opiekun" value="<?php echo $det->GUARDIAN; ?>">
		                </div>
		              </div>
		            ...
		            <div class="row">
		              <div class="col-md-6">
		                ...
		                "otherperson"></label> 
		                  ...
		                  "text" placeholder="" value="<?php echo $det->OTHER_PERSON_SUPPORT; ?>">
		                </div>
		              </div>
