		  ...
		  <!-- <form class="form-horizontal span4" action="#.php" method="POST"> -->
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Przedmioty Studenta</h3>
					  </div>
					  <div class="panel-body">
			           ...
			           <div class="container">
				           ...
				           <table > 
						     ...
						     <tbody>
						     	<tr>
						     		...
						     		<td>
						     			<p><b>ID Numer : </b><?php echo (isset($cur)) ? $cur->IDNO : 'ID' ;?><br/>
						     		<b>Imie :</b><?php echo (isset($cur)) ? $cur->LNAME.', '.$cur->FNAME : 'Fullname' ;?><br/>
						     		<b>Status : </b><?php echo (isset($sy)) ? $sy->STATUS : 'STATUS' ;?><br/>
						     		<b>RK : </b><?php echo (isset($sy)) ? $sy->AY : 'STATUS' ;?><br/>
						     	<!--	<td> <?php //echo (isset($sy)) ? $sy->SEMESTER : 'COURSE' ;?></td>-->
						     		<b>Rok/Sekcja : </b><?php echo (isset($studcourse)) ? $studcourse->COURSE_DESC : 'Department' ;?>
						     		</p></td>
						...
						<a href="index.php?view=view&studentId=<?php echo $_GET['studentId'];?>" class="btn btn-default">  Cofnij</a>
						<?php 
						 if($_SESSION['ACCOUNT_TYPE']=='Administrator'){
