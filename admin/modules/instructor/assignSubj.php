		<div class="well">
			<h3 align="left">Lista przedmiotow</h3>
				...
				<div class="btn-group">
				  <a href="index.php?view=instSubj&instructorId=<?php echo (isset($instructorId)) ? $instructorId : 'ID' ;?>" class="btn btn-default"><span class="glyphicon glyphicon-back"></span>powrot</a>
				  <button type="submit" class="btn btn-default" name="Add"><span class="glyphicon glyphicon-plus-sign"></span>ybrane</button>
				</div>
				</form>
	  	</div><!--End of well-->
