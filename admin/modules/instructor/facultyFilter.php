				          ...
				          <div class="form-group" id="instuctorId">
				            <div class="col-md-10">
				             <label class="col-md-4 control-label" for=
				                "FullName">Imie i Nazwisko:</label>
						...
						<div class="form-group" id="instuctorId">
				            <div class="col-md-10">
				               <label class="col-md-4 control-label"></label>
				                ...
				                <div class="col-md-8">
							         <div class="btn-group">
									    <button type="submit" name="search" class="btn btn-default"><span class="glyphicon glyphicon-search"></span> Szukaj</button>
									    <button type="Reset" name="search" class="btn btn-default"><span class="glyphicon glyphicon-refresh"></span> Reset</button>
									    <a href="newfaculty.php" name="add" class="btn btn-default"> <span class="glyphicon glyphicon-plus"></span> Dodaj</a>
