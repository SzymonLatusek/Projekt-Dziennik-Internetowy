    	...
    	<form class="form-horizontal span4" action="" method="POST">
		    ...
		    <tbody>
		     	<tr>
		     		<td>
		     			<p>
				     		<b>Imie i Nazwisko : </b><?php echo (isset($cur)) ? $cur->INST_FULLNAME : 'Fullname' ;?><br/>
				     		<b>Plec : </b><?php echo (isset($cur)) ? $cur->INST_SEX  : 'Sex' ;?><br/>
				     		<b>Status : </b><?php echo (isset($cur)) ? $cur->EMPLOYMENT_STATUS : 'EMPLOYMENT STATUS' ;?><br/>
				     		<b>Specializacja : </b><?php echo (isset($cur)) ? $cur->SPECIALIZATION : 'SPECIALIZATION' ;?><br/>
				     		<b>Adres : </b><?php echo (isset($cur)) ? $cur->INST_ADDRESS : 'Address' ;?>
	  		...
	  		<!--	<tfoot>
				...
				<div class="btn-group">
				  <a href="index.php" class="btn btn-default">Powrót</a>
				   <a href="index.php?view=assign&instructorId=<?php  echo (isset($_GET['instructorId'])) ? $_GET['instructorId']: 'ID' ; ?>" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>  Przydzielone Przedmioty</a>
