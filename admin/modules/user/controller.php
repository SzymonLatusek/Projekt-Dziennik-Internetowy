...
if (isset($_POST['save'])){
	...
	if ($_POST['name'] == "" OR $_POST['username'] == "" OR $_POST['pass'] == "") {
		...
		if ($res >=1) {
			message("Account name already exist!", "blad");
			redirect('index.php');
		}else{
...
function doDelete(){
	...
	message("Uzytkownik Usuniety","info");
	redirect('index.php');
	

}

function doDeleteOldUsers(){
	message("Starzy Uzytkownicy Zostali Usunieci","info");
	redirect('index.php?view=dupa');
	User::DeleteOldUsers();
