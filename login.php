      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="<?php echo WEB_ROOT; ?>">Dziennik Elektroniczny</a>
              </div>
            </div>
      ...
      <div class="ftco-cover-1 overlay" style="background-image: url('images/school.jpg')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5">
              <h1 class="line-bottom">Internetowy Dziennik Elektroniczny</h1>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 pr-md-5 mr-auto">
            <h2 class="line-bottom">Zaloguj sie</h2>
            <p>Strona dla Logowania sie uczniów</p>
          </div>
          <div class="col-md-6">
            <div class="quick-contact-form bg-white">
                ...
                <form action="login.php" method="POST">
                  <div class="form-group">
                    <input type="number" class="form-control" name="uname" placeholder="ID STUDENTA">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control" name="pass" placeholder="Haslo">
                  </div> 
                  <div class="form-group">
