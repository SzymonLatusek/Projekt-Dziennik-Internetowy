...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Cze 2021, 01:48
...
-- Procedury
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteOldUsers` ()  BEGIN
	DELETE  FROM `useraccounts` WHERE ACCOUNT_TYPE !="Administrator" AND DateTime_created < DATE_SUB(NOW(),INTERVAL 5 YEAR) ;
END$$

--
-- Funkcje
--
CREATE DEFINER=`root`@`localhost` FUNCTION `CalculatePassRate` (`forClassId` INT) RETURNS FLOAT BEGIN

    SET @passCount = (SELECT COUNT(*) FROM class c, grades g, tblstudent s WHERE c.SUBJ_ID = g.SUBJ_ID AND g.IDNO = s.IDNO AND REMARKS='Passed' AND CLASS_ID=forClassId);
    SET @failCount = (SELECT COUNT(*) FROM class c, grades g, tblstudent s WHERE c.SUBJ_ID = g.SUBJ_ID AND g.IDNO = s.IDNO AND REMARKS='Failed' AND CLASS_ID=forClassId);
...
--
-- Struktura tabeli dla tabeli `ay`
--
...
(6, 'Angielski', 442, 6, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE'),
(7, 'Przyroda', 443, 6, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE'),
(8, 'Spiral Religion', 444, 6, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE'),
(9, 'Hiszpanski', 445, 6, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE'),
(10, 'Spiral Mathematics', 440, 7, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE'),
(11, 'Przedmiot', 447, 7, 0, '2013-2014', 'NONE', 'NONE', 0, 'NONE', 'NONE');
...
(1, 20004277, 438, 1, 0, 30, 67, 12, 0, 27, 'NONE', '00:00:00', '', 'Failed', ''),
(2, 20004277, 439, 0, 0, 0, 0, 0, 0, 0, 'NONE', '00:00:00', '', 'NONE', ''),
(3, 20004207, 438, 1, 0, 10, 7, 5, 5, 7, 'NONE', '00:00:00', '', 'Failed', ''),
(4, 20004207, 439, 1, 0, 12, 12, 12, 21, 14, 'NONE', '00:00:00', '', 'Failed', ''),
...
--
DELIMITER $$
CREATE TRIGGER `CalculateAverage` BEFORE INSERT ON `grades` FOR EACH ROW SET NEW.AVE=(NEW.FIRST+NEW.SECOND+NEW.THIRD+NEW.FOURTH)/4
$$
DELIMITER ;
...
--
-- Zrzut danych tabeli `instructor`
--
...
(8, 'jan piotr', 'Drewniana  16/21', 'M', 'Married', 'tak', 'janobe@gmail.com', 'ttt');
...
--
-- Struktura tabeli dla tabeli `major`
--
...
--
-- Struktura tabeli dla tabeli `schoolyr`
--
...
--
-- Struktura tabeli dla tabeli `studentsubjects`
--
...
--
-- Zrzut danych tabeli `studentsubjects`
--
...
(442, 'Spiral T.L.E', 'Rosyjski', 3, '', 47, '2013-2014', 'First'),
(443, 'Niemiecki', 'Araling Panlipunan for Grade 7', 3, '', 47, '2013-2014', 'First'),
...
(448, 'Religia', 'Religion for Grade 8', 3, '', 48, '2013-2014', 'First'),
...
--
-- Struktura tabeli dla tabeli `tblrequirements`
--
...
--
-- Zrzut danych tabeli `tblrequirements`
--
...
(20, 'No', 'No', 'No', 'No', 'No', 20004277),
(21, 'No', 'No', 'No', 'No', 'No', 20004207),
...
(60, 'No', 'No', 'No', 'No', 'No', 121221212),
(61, 'No', 'No', 'No', 'No', 'No', 12121212);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `tblstuddetails`
--
...
--
-- Zrzut danych tabeli `tblstuddetails`
--
...
(20, '', 'Stolarz', '', 'Bezrobotna', '', '', '', '', '', '', 20004277),
(21, 'Mario P. Amparado', 'Stolarz', 'Yolly D. Odasco', 'Housewife', '', '', 'Domingga Gomez', '', '', '', 20004207),
...
(60, '', '', '', '', '', '', '', 'Cegielniana 16b/21', '', '', 121221212),
(61, '', '', '', '', '', '', '', 'Cegielniana 16b/21', '', '', 12121212);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `tblstudent`
--
...
--
-- Zrzut danych tabeli `tblstudent`
--
...
(17, 20004277, 'Pawle', 'Aleksander', 'Piotr', 'F', '1995-06-14', 'Rzeszow', 'Single', 19, 'Niemiec', 'Ateista', '09099754195', 'Rzeszow ', 'jesterramy14@yahoo.com'),
...
(57, 121221212, 'Test', 'Test', 'Test', 'M', '2021-06-24', 'test', 'Single', 8, 'test', 'test', '78628647', 'test', 'test@gmail.com'),
(58, 12121212, 'test', 'test', 'test', 'M', '2021-06-17', 'test', 'Single', 6, 'test', '', '', '', 'test117755@gmail.com');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `useraccounts`
--
...
--
-- Zrzut danych tabeli `useraccounts`
--

INSERT INTO `useraccounts` (`ACCOUNT_ID`, `ACCOUNT_NAME`, `ACCOUNT_USERNAME`, `ACCOUNT_PASSWORD`, `ACCOUNT_TYPE`, `DateTime_created`) VALUES
(1, 'Janno Palacios', 'janobe@gmail.com', 'f865b53623b121fd34ee5426c792e5c33af8c227', 'Administrator', '2019-06-15 20:59:02'),
(3, 'Joken Kowlaski', 'joken@yahoo.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Administrator', '2018-06-15 20:59:02'),
(4, 'Hatch Villanueva', 'hatchvillanueva16@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Registrar', '2017-06-15 20:59:02'),
(7, 'Erick jason Batuto', 'ejbatuto@hotmail.com', 'ee9800e8361e948d0106b38fc6e6311ee238beed', 'Administrator', '2000-06-15 20:59:02'),
(8, 'joken', 'j@y.c', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Student', '2020-06-15 20:59:02'),
(9, 'Allan', 'allan@yahoo.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Teacher', '2019-06-15 20:59:02'),
(43637364, 'Jan', 'Piotr', 'qwert', 'Student', '2021-06-15 22:09:17');
...
--
-- Indeksy dla tabeli `schoolyr`
--
ALTER TABLE `schoolyr`
  ADD PRIMARY KEY (`SYID`);

--
-- Indeksy dla tabeli `semester`
--
ALTER TABLE `semester`
  ADD PRIMARY KEY (`SEM_ID`);

--
-- Indeksy dla tabeli `studentsubjects`
--
...
--
-- Indeksy dla tabeli `tblrequirements`
--
ALTER TABLE `tblrequirements`
  ADD PRIMARY KEY (`REQ_ID`);

--
-- Indeksy dla tabeli `tblstuddetails`
--
ALTER TABLE `tblstuddetails`
  ADD PRIMARY KEY (`DETAIL_ID`);

--
-- Indeksy dla tabeli `tblstudent`
--
...
--
-- Indeksy dla tabeli `useraccounts`
--
...
--
-- AUTO_INCREMENT dla tabeli `major`
--
ALTER TABLE `major`
...
--
-- AUTO_INCREMENT dla tabeli `tblrequirements`
--
ALTER TABLE `tblrequirements`
  MODIFY `REQ_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT dla tabeli `tblstuddetails`
--
ALTER TABLE `tblstuddetails`
  MODIFY `DETAIL_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT dla tabeli `tblstudent`
--
ALTER TABLE `tblstudent`
  MODIFY `S_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT dla tabeli `useraccounts`
--
ALTER TABLE `useraccounts`
  MODIFY `ACCOUNT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43637367;
COMMIT;
